...
def _finalize_news_output(final_report, event_blueprints, valid_event_ids, raw_search_results, topic, ai_driver=None):
    if not final_report:
...
def map_reduce_analysis(
    ...
    if len(docs) <= 2:
        ...
        return _finalize_news_output(direct_report, event_blueprints, valid_event_ids, raw_search_results, topic, ai_driver=ai_driver)
    ...
    return _finalize_news_output(final_report, event_blueprints, valid_event_ids, raw_search_results, topic, ai_driver=ai_driver)
