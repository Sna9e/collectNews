...
CONSUMER_ELECTRONICS_TOPICS = [
    {
        "title": "消费电子与手机新品",
        "queries": [
            "苹果 三星 华为 小米 vivo OPPO 一加 手机 新品 参数 升级 发布",
            "智能手机 影像 芯片 屏幕 电池 快充 AI 功能 最新",
            "iOS Android HarmonyOS HyperOS OriginOS ColorOS 手机系统 软件 最新资讯",
        ],
    ...
    },
    {
        "title": "AR/VR与AI眼镜",
        "queries": [
            "AR VR AI眼镜 Meta 雷鸟 Rokid Xreal Apple Vision Pro 最新",
            "智能眼镜 光波导 MicroLED LCoS Micro OLED 供应商 量产",
            "AI眼镜 国内厂商 雷鸟 Rokid XREAL 华为 小米 供应链 最新",
        ],
    ...
    },
    {
        "title": "AI一周重要资讯",
        "queries": [
            "豆包 OpenAI Anthropic 大模型 多模态 端侧AI 最新",
            "中国 AI 大模型 字节 阿里 百度 腾讯 华为 DeepSeek 最新",
            "AI 模型 推理 芯片 手机 PC 终端部署 应用 最新",
        ],
        ...
        "companies": ["豆包", "字节", "DeepSeek", "阿里", "百度", "腾讯", "华为", "OpenAI", "Anthropic", "Google"],
    ...
    },
    {
        "title": "电动汽车智能科技",
        "queries": [
            "鸿蒙智行 比亚迪 小鹏 理想 蔚来 特斯拉 智能驾驶 座舱 最新",
            "新能源汽车 激光雷达 800V 电池 快充 OTA 供应链 最新",
            "华为 比亚迪 小鹏 智驾 芯片 传感器 新车型 发布",
        ],
    ...
    },
    {
        "title": "折叠屏与新型显示",
        "queries": [
            "折叠手机 华为 vivo OPPO 小米 三星 苹果 铰链 屏幕 最新",
            "fast lcd lcos micro oled micro led 近眼显示 量产 供应链",
            "折叠屏 LTPO UTG CPI 铰链 FPC 供应链 最新",
        ],
