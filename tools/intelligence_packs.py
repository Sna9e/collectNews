...
EXPANDED_TREND_TOPICS = [
    {
        ...
        "tags": ["AI手机", "SoC", "SLP", "FPC", "散热", "模组"],
        "keywords": [
            "ai手机", "on-device ai", "slp", "fpc", "sip", "npu", "modem",
            "散热", "vc", "camera module", "battery", "端侧ai"
        ],
        "companies": ["苹果", "三星", "华为", "荣耀", "小米", "OPPO", "vivo", "高通", "联发科"],
        "domains": ["androidauthority.com", "gsmarena.com", "ithome.com", "ijiwei.com", "36kr.com"],
        "china_domains": ["ithome.com", "ijiwei.com", "36kr.com"],
    },
    {
        "title": "折叠与多维形态变革",
        "queries": ["三折叠手机 最新发布", "卷轴屏 手机 量产", "无孔化手机 Waterproof Buttonless 设计"],
        "desc": "关注三折叠手机、卷轴屏、以及无孔化设计的最新突破。",
        "tags": ["折叠屏", "三折叠", "卷轴屏", "UTG", "铰链", "cover window"],
        "keywords": [
            "foldable", "tri-fold", "卷轴屏", "hinge", "utg", "cover window",
            "折痕", "柔性oled", "waterproof", "buttonless"
        ],
        "companies": ["苹果", "三星", "华为", "荣耀", "小米", "京东方", "三星显示"],
        "domains": ["displaydaily.com", "sammobile.com", "macrumors.com", "ithome.com", "ijiwei.com"],
        "china_domains": ["ithome.com", "ijiwei.com"],
    },
    {
        "title": "6G预研与卫星通讯",
        "queries": ["6G预研 最新进展", "高通 6G AI 整合芯片", "卫星通讯 手机直连 NTN"],
        "desc": "重点关注高通6GAI芯片及卫星直连技术（NTN）的进展。",
        "tags": ["6G", "NTN", "卫星直连", "基带芯片", "终端模组"],
        "keywords": [
            "6g", "ntn", "satellite direct-to-device", "卫星直连", "基带",
            "modem", "相控阵", "终端模组", "手机直连卫星"
        ],
        "companies": ["高通", "联发科", "华为", "苹果", "Globalstar", "SpaceX", "中国卫通"],
        "domains": ["lightreading.com", "spacenews.com", "c114.com.cn", "ithome.com", "elecfans.com"],
        "china_domains": ["c114.com.cn", "ithome.com", "elecfans.com"],
    },
    {
        "title": "AI穿戴与XR设备",
        "queries": ["超轻量化 AI眼镜 评测", "智能戒指 SmartRing 生态", "XR混合现实 硬件 创新"],
        "desc": "关注超轻量化AI眼镜、智能戒指的爆款产品。",
        "tags": ["AI眼镜", "XR", "智能戒指", "光波导", "Micro OLED"],
        "keywords": [
            "ai glasses", "smart ring", "xr", "mixed reality", "waveguide",
            "micro oled", "see-through", "spatial computing", "lightweight headset"
        ],
        "companies": ["Meta", "苹果", "Rokid", "XREAL", "雷鸟", "三星"],
        "domains": ["uploadvr.com", "roadtovr.com", "theverge.com", "ithome.com", "36kr.com"],
        "china_domains": ["ithome.com", "36kr.com"],
    },
    {
        "title": "先进制造与绿色制程",
        "queries": ["半导体 绿色制程 节能 fab 扩产", "消费电子 供应链 碳足迹 制造 法规", "先进封装 测试 制造 能耗"],
        "desc": "关注半导体与消费电子制造环节的节能工艺、先进封装、碳足迹合规和量产制造变化。",
        "tags": ["先进制造", "绿色制程", "先进封装", "测试", "碳足迹"],
        "keywords": [
            "绿色制程", "节能fab", "先进封装", "coos", "osat", "碳足迹",
            "制造能耗", "可持续制造", "封装测试", "工厂扩产"
        ],
        "companies": ["台积电", "英特尔", "日月光", "长电科技", "通富微电", "苹果供应链"],
        "domains": ["digitimes.com", "semiengineering.com", "ithome.com", "ijiwei.com", "36kr.com"],
        "china_domains": ["ithome.com", "ijiwei.com", "36kr.com"],
    },
    {
        "title": "全球机器人产业巡视",
        "queries": ["全球 机器人 产业 报告 2026", "特斯拉 宇树科技 机器人 动态", "人形机器人 创业公司", "人形机器人 减速器 伺服 电池 供应链"],
        "desc": "考察全球及中国厂商，覆盖大厂及新兴创业厂商。",
        "tags": ["人形机器人", "执行器", "减速器", "伺服", "电池"],
        "keywords": [
            "humanoid", "机器人", "执行器", "减速器", "伺服", "关节模组",
            "battery", "supply chain", "量产", "bipedal"
        ],
        "companies": ["特斯拉", "宇树科技", "优必选", "智元", "Figure", "Apptronik"],
        "domains": ["theinformation.com", "techcrunch.com", "36kr.com", "leiphone.com", "gasgoo.com"],
        "china_domains": ["36kr.com", "leiphone.com", "gasgoo.com"],
    },
]
