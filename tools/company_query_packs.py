...
MEGACAP_QUERY_PACKS = {
    ...
    "tesla": {
        ...
        "domains": [
            ...
            "gasgoo.com", "d1ev.com", "36kr.com", "wallstreetcn.com", "cls.cn", "autohome.com.cn",
        ],
        "focus_lines": [
            "优先覆盖 FSD 在中国的备案、审批、试点、功能开放、城市导航、合作落地和监管推进，不要只保留 robotaxi 或财报。",
            "如果出现中国本地试点城市、工信部/地方监管、合作伙伴或上海工厂协同信号，应优先保留。",
        ],
        "keywords": [
            ...
            "filing", "record filing", "miit", "regulator", "smart driving"
        ],
        "priority_terms": [
            ...
            "filing", "record filing", "miit", "regulator"
        ],
        ...
        "queries": [
            ...
            "{topic} FSD China filing MIIT regulator pilot city latest",
